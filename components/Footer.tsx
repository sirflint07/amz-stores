...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover">About <span className='font-black'>AMZ</span></a>
...
<p className='text-center bg-base-300 text-gray-400 font-bold text-lg p-4'>Copyright © 2024 - All right reserved by AMZ - Fashion Ltd</p>
    </>
  )
}
